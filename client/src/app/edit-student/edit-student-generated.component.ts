/*
  ...
  Modify edit-student.component.ts instead.
*/
...
export class EditStudentGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  load() {
    this.conDb.getStudentByStudentId(null, this.parameters.StudentID)
  ...
  form0Submit(event: any) {
    this.conDb.updateStudent(null, this.parameters.StudentID, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to update Student` });
    });
  }
}
